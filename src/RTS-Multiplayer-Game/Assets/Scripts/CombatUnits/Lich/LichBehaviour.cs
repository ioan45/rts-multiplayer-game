...
public class LichBehaviour : MonoBehaviour
{
    [SerializeField]
    ...
    public void OnAttackSuccesAnimFrame()
    {
        ...
        {
            LichAttackProjectile projectile = Instantiate(projectilePrefab, firePoint.position, Quaternion.identity).GetComponent<LichAttackProjectile>();
